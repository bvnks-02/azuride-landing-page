...
export function HeroSection({ heroSlot }: { heroSlot?: React.ReactNode }) {
  return (
    <section
      id="hero"
      className="mx-auto flex min-h-[calc(100dvh-4rem)] max-w-[1200px] flex-col items-center justify-center bg-white px-6 py-16 text-center lg:px-16"
    >
      ...
      <p className="text-body-lg mt-6 max-w-2xl text-slate">
        {SITE_NAME} is one ecosystem with four branches: reality capture,
        visual production, software engineering, and healthcare innovation.
        All built around a single core.
      </p>
    </section>
  );
}
